...
--awful.util.tagnames = {  " ", " ", " ", " ", " ", " ", " ", " ", " ", " "  }
--awful.util.tagnames = { " あ ", " い ", " う ", " え ", " お ", " 中 ", " 川 ", " カ ", " か " }
awful.util.tagnames = {  " ", " メ-ル", " ゲ-ム", " TXT", " ZSH", " MPV", " MUS" , " Δ", " Ω" , " Α"}
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, "Shift" }, "e", function () awful.util.spawn( "emacsclient -a 'emacs' -c" ) end,
    ...
    -- screenshots
    awful.key({ }, "Print", function () awful.util.spawn("scrot 'pc01-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir PICTURES)'") end,
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    awful.key({ modkey,           }, "Return", function () awful.spawn( terminal.." -e zsh" ) end,
              {description = "terminal with zsh because fish is for fags", group = "super"}),
...
awful.spawn.with_shell("~/wallpaper/wallpaper.sh")
