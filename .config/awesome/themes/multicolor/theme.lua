...
theme.wallpaper                                 = theme.confdir .. "/bg.png", "/awesome.jpg"
theme.font                                      = "azukifontb 18"
theme.taglist_font                              = "azukifontb 18"
theme.menu_bg_normal                            = "#2D2B55"
theme.menu_bg_focus                             = "#4D21FC"
theme.bg_normal                                 = "#2D2B55"
theme.bg_focus                                  = "#2D2B55"
theme.bg_urgent                                 = "#FF7200"
theme.fg_normal                                 = "#A599E9" --text
theme.fg_focus                                  = "#B362FF"
theme.fg_urgent                                 = "#FAD000"
theme.fg_minimize                               = "#FAEFA5" --text
...
local mytextclock = wibox.widget.textclock(markup("#A599E9", "%A %d %B ") .. markup("#B362FF", "日常") .. markup("#A599E9", " %I:%M "))
...
theme.volume = lain.widget.alsa({
    settings = function()
        ...
        widget:set_markup(markup.fontfg(theme.font, "#D0C8C6", volume_now.level .. "% "))
    end
})
...
local new_shape = function(cr, width, height)
    gears.shape.rounded_rect(cr, width, height, 19)
end

s.mybottomwibox = awful.wibar({ position = "top", screen = s, border_width = 0, height = 8, opacity=0 })

    -- Create the wibox
 s.mywibox = awful.wibar({  position = "top", screen = s, height = 28, bg = theme.bg_normal, fg = theme.fg_normal , width=1900 })
