...
group_names = [("WWW", {'layout': 'monadtall'}),
               ("メ-ル", {'layout': 'monadtall'}),
               ("ゲ-ム", {'layout': 'monadtall'}),
               ("TxT", {'layout': 'monadtall'}),
               ("ZSH", {'layout': 'monadtall'}),
               ("MPV", {'layout': 'monadtall'}),
               ("δ", {'layout': 'monadtall'}),
               ("ω", {'layout': 'monadtall'}),
               ("α", {'layout': 'floating'})]
...
colors = [["#2D2B55", "#2D2B55"], # panel background
          ["#1E1E3F", "#1E1E3F"], # background for current screen tab
          ["#A599E9", "#A599E9"], # font color for group names
          ["#4D21FC", "#4D21FC"], # border line color for current tab
