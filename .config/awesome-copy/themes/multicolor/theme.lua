...
theme.wallpaper                                 = theme.confdir .. "/bg.png"
theme.font                                      = "azukifontb 11"
theme.taglist_font                              = "azukifontb 13"
theme.menu_bg_normal                            = "#3B3228"
theme.menu_bg_focus                             = "#3B3228"
theme.bg_normal                                 = "#3B3228"
theme.bg_focus                                  = "#3B3228"
theme.bg_urgent                                 = "#7E705A"
theme.fg_normal                                 = "#D0C8C6" --text
theme.fg_focus                                  = "#fedbd2"
theme.fg_urgent                                 = "#F4BC87"
theme.fg_minimize                               = "#525852" --text
...
local mytextclock = wibox.widget.textclock(markup("#7E705A", "%A %d %B ") .. markup("#D0C8C6", "日常") .. markup("#7E705A", " %I:%M "))
...
local new_shape = function(cr, width, height)
    ...
    -- Create the wibox
   s.mywibox = awful.wibar({  shape=new_shape , position = "top", screen = s, height = 28, bg = theme.bg_normal, fg = theme.fg_normal ,  opacity=.75   })
